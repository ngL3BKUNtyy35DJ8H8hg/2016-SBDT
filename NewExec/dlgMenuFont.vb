...
Namespace SaBan
	...
	Public Class dlgMenuFont
		...
		Public Sub New()
			AddHandler MyBase.Load, AddressOf Me.dlgMenuFont_Load
		...
		Private Sub InitializeComponent()
			...
			Dim location As Point = New Point(636, 123)
			...
			Dim arg_23A_0 As Control = Me.txtLabel
			location = New Point(12, 12)
			arg_23A_0.Location = location
			Me.txtLabel.Multiline = True
			Me.txtLabel.Name = "txtLabel"
			Dim arg_270_0 As Control = Me.txtLabel
			size = New Size(770, 89)
			arg_270_0.Size = size
		...
		Private Sub dlgMenuFont_Load(sender As Object, e As EventArgs)
		End Sub
