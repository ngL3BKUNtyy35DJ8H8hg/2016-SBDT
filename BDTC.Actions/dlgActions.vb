...
#Region "CODEEDIT: RaiseEvents"
    Public Event IsNameOKEvent(ByRef result As Boolean)
    'New Function
    Public Function IsNameOK(ByVal pName As String) As Boolean
        Dim Kq As Boolean = True
        ' Raise an event. 
        RaiseEvent IsNameOKEvent(Kq)
        Return Kq
    End Function
    ...
    Public Event ExportObjsEvent(ByVal pActions As List(Of CActionDef))
    Private Sub ExportObjs()
        ...
        Next
        ' Raise an event. 
        RaiseEvent ExportObjsEvent(allActions)
    ...
    Public Event OnGetObjNameEvent(ByVal ptxtKQ As TextBox, ByVal ptxtObjType As TextBox)
    Public Sub OnGetObjName(ByVal ptxtKQ As TextBox, ByVal ptxtObjType As TextBox)
        RaiseEvent OnGetObjNameEvent(ptxtKQ, ptxtObjType)
    End Sub

    Public Event OnGetTargetEvent(ByVal ptxtKQ As TextBox, ByVal pDoCao As Single)
    Public Sub OnGetTarget(ByVal ptxtKQ As TextBox, ByVal pDoCao As Single)
        RaiseEvent OnGetTargetEvent(ptxtKQ, pDoCao)
    End Sub
#End Region
